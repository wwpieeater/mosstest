...
public class RenderProcessor extends SimpleApplication {
    ...
    static double raycasterMod(double value, double modulus) {
        return ((value % modulus) + modulus) % modulus;
    }

    static NodePosition raycast(NodePosition worldPos, Vector3f traceOrigin, Vector3f camDirection, int radius) {
        ...
        for (int i = 0; i < 20; i++) {
            ...
            if (nodeAcceptable(x, y, z, face)) {
                ...
                return new NodePosition(worldPos.chunk.realm,
                        (int) (combinedX/16),
                        (int) (combinedY/16),
                        (int) (combinedZ/16),
                        (byte)(combinedX%16),
    ...
    public static void main(String[] args) {
        raycast(null, new Vector3f(3.1f, 8.5f, 2.0f), new Vector3f(0, 0.0f, 0), 8);
    }

    private static boolean nodeAcceptable(double x, double y, double z, Vector3f face) {
